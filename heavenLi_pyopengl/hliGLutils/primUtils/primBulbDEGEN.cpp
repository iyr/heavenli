...
int defineBulb(
   ...
   defineArch(bx+(bs+bs*thickness*0.5f)*cosf(degToRad(310.0f)), by+(bs+bs*thickness*0.5f)*sinf(degToRad(310.0f)), 0.0f, 0.0f, 125.0f, 310.0f, bs*thickness*0.5f, circleSegments, detailColor, verts, colrs);
   defineQuad2pt(bx-bs*thickness, by-bs*2.25f, bx-bs*thickness*2.0f, by-bs*1.6f, detailColor, verts, colrs);
   defineQuad2pt(bx+bs*thickness, by-bs*1.6f, bx+bs*thickness*2.0f, by-bs*2.25f, detailColor, verts, colrs);
...
int updateBulbGeometry(
   ...
   index = updateArchGeometry(bx+(bs+bs*thickness*0.5f)*cosf(degToRad(310.0f)), by+(bs+bs*thickness*0.5f)*sinf(degToRad(310.0f)), 0.0f, 0.0f, 125.0f, 310.0f, bs*thickness*0.5f, circleSegments, index, verts);
   index = updateQuad2ptGeometry(bx-bs*thickness, by-bs*2.25f, bx-bs*thickness*2.0f, by-bs*1.6f, index, verts);
   index = updateQuad2ptGeometry(bx+bs*thickness, by-bs*1.6f, bx+bs*thickness*2.0f, by-bs*2.25f, index, verts);
